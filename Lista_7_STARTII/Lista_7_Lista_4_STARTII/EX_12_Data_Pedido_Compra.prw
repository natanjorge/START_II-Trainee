...
/*/ {Protheus.doc} User Function EX_12_Data_Pedido_Compra
    O programa solicita ao usuário uma data de início e fim para saber quais são os pedidos existentes nos período.
    @type  User Function
    @author Natan Jorge
    @since 13/03/2023
    @version version
...
User Function EX_12_Data_Pedido_Compra()
    ...
    Local cTitle := 'BUSCA PRODUTO', cMsg_Data_inicio := 'Digite a data de início: ', cMsg_Data_fim := 'Digite a data de fim: '
