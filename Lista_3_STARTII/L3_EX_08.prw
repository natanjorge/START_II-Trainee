...
User Function ProdMaiorValor()
	...
	cQuery := 'SELECT C6_PRODUTO, C6_DESCRI, C6_PRCVEN, C6_VALOR, C5_NUM' + CRLF + "FROM " + RetSqlName('SC5') + " SC5" + CRLF + "INNER JOIN " + RetSqlName('SC6') + " SC6" + " ON " + "C5_NUM = " + 'C6_NUM' + CRLF + "ORDER BY C6_VALOR DESC "
